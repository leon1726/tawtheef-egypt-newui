...
export default async function JobDetailPage({ params }: Props) {
  ...
  const catInitials = categoryIcon(job.category);
  const [catBg, catFg] = categoryColors(job.category);
            ...
            <article className="flex-1 min-w-0 space-y-5">
              ...
              <div className="rounded-2xl border p-6 md:p-8"
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-start">
                  <div
                    className="w-16 h-16 rounded-xl flex items-center justify-center text-lg font-bold flex-shrink-0 select-none"
